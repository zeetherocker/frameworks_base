    ...
    private final Runnable mDoubleTapTimeoutRunnable = new Runnable() {
        ...
        public void run() {
            if (mHomeDoubleTapPending) {
                ...
                OSEActions.processAction(mContext, mPressOnHomeBehavior, false);
            }
            if (mMenuDoubleTapPending) {
                ...
                OSEActions.processAction(mContext, mPressOnMenuBehavior, false);
            }
            if (mBackDoubleTapPending) {
                ...
                OSEActions.processAction(mContext, mPressOnBackBehavior, false);
            }
            if (mAppSwitchDoubleTapPending) {
                ...
                OSEActions.processAction(mContext, mPressOnAppSwitchBehavior, false);
            }
            if (mAssistDoubleTapPending) {
                ...
                OSEActions.processAction(mContext, mPressOnAssistBehavior, false);
            }
        }
    };
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mHomeDoubleTapPending) {
                        ...
                        OSEActions.processAction(mContext, mDoubleTapOnHomeBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        OSEActions.processAction(mContext, mLongPressOnHomeBehavior, false);
                        mHomeConsumed = true;
                    }
                }
            }
            ...
            if (virtualKey && down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mMenuDoubleTapPending) {
                        ...
                        OSEActions.processAction(mContext, mDoubleTapOnMenuBehavior, false);
                        return -1;
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        OSEActions.processAction(mContext, mLongPressOnMenuBehavior, false);
                        mMenuConsumed = true;
                        return -1;
                    }
                }
            ...
            if (!down && mAppSwitchPressed) {
                ...
                OSEActions.processAction(mContext,
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mAppSwitchDoubleTapPending) {
                        ...
                        OSEActions.processAction(mContext, mDoubleTapOnAppSwitchBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        OSEActions.processAction(mContext, mLongPressOnAppSwitchBehavior, false);
                        mAppSwitchConsumed = true;
                    }
                }
            }
            ...
            if (down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mAssistDoubleTapPending) {
                        ...
                        OSEActions.processAction(mContext, mDoubleTapOnAssistBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        OSEActions.processAction(mContext, mLongPressOnAssistBehavior, false);
                        mAssistConsumed = true;
                    }
                }
            }
            ...
            if (virtualKey && down) {
                ...
                if (repeatCount == 0) {
                    ...
                    if (mBackDoubleTapPending) {
                        ...
                        OSEActions.processAction(mContext, mDoubleTapOnBackBehavior, false);
                    }
                } else if (longPress) {
                    if (!keyguardOn
                        ...
                        performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                        OSEActions.processAction(mContext, mLongPressOnBackBehavior, false);
                        mBackConsumed = true;
                    }
                }
            }

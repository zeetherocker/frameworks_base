...
package com.android.systemui.oserecent;
...
public class RecentController implements RecentPanelView.OnExitListener,
    ...
    private static final String TAG = "OSERecentsController";
    ...
    public RecentController(Context context, int layoutDirection) {
        ...
        mRecentContainer =
                (RelativeLayout) View.inflate(context, R.layout.ose_recent, null);
